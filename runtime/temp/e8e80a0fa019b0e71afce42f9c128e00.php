<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"F:\twothink\TwoThink\public/../application/home/view/default/guarante\notice.html";i:1521805687;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="row noticeList">
            <div class="col-xs-2">
                <img class="noticeImg" src="__PUBLIC__/home/static/image/1.png" />
            </div>
            <div class="col-xs-10">
                <p class="title"><a href="">关于XXX小区业主委员会选举的公告</a></p>
                <p class="intro">经过几年的摸索,XXX小区的业主委会员已经</p>
