<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\twothink\TwoThink\public/../application/admin/view/default/rental\edit.html";i:1522053332;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="radio" value="0" name="statr" <?=$row['statr']?'':'checked'?>/>租
                <input type="radio" value="1" name="statr"
                <?=$row['statr']?'checked':''?>/>售
            </div>
            <div class="form-group">
                <img src="<?=$row['picture']?>" alt="" width="100">
                <label>图片(必填):</label>
