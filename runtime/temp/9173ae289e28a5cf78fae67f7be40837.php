<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\twothink\TwoThink\public/../application/home/view/default/rental\index.html";i:1522055916;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-4">
                            ...
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h4><?=$r['username']?></h4>
                                    <p class="zushouInfo"><?=$r['title']?></p>
                                    <p class="text-danger"><?=$r['money']?>元/月</p>
                                    <p><a href="<?php echo url('home/rental/look',['id'=>$r[id]]); ?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
                            <?php endforeach;?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h4><?=$row['username']?></h4>
                                    <p class="zushouInfo"><?=$row['title']?></p>
                                    <p class="text-danger"><?=$row['money']?>/月</p>
                                    <p><a href="<?php echo url('home/rental/look',['id'=>$row[id]]); ?>" class="btn btn-danger zushouBtn">详细内容</a></p>
                                </div>
                            </div>
                        </div>
                        <?php endforeach;?>
