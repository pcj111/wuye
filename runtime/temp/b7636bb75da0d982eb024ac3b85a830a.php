<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\twothink\TwoThink\public/../application/home/view/default/inform\index.html";i:1521878530;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="row noticeList">
            <a href="<?php echo url('lists?id='.$row->id); ?>">
                <div class="col-xs-2">
                    <img class="noticeImg" src="<?=$row->img?>"/>
                </div>
                <div class="col-xs-10">
                    <p class="title"><?=$row->title?></p>
                    <p class="intro"><?=$row->author?></p>
                    <p class="info">浏览: <?=$row->rate?> <span class="pull-right"><?=$row->create_time?></span> </p>
                </div>
            </a>
        </div>
        <?php endforeach;?>
