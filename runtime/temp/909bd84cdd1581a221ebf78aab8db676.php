<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"F:\twothink\TwoThink\public/../application/home/view/default/guarante\index.html";i:1522053888;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="container-fluid">
    <div class="indexImg row">
        <img src="__PUBLIC__/home/static/image/index.png" width="100%" />
    </div>
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <a href="http://www.twothink.cc/home/inform/index.html">
                ...
                <div class="col-xs-4">
                    <a href="http://www.twothink.cc/home/guarante/property.html">
                ...
                <div class="col-xs-4">
                    <a href="http://www.twothink.cc/home/active/index.html">
                ...
                <div class="col-xs-4">
                    <a href="http://www.twothink.cc/home/rental/index.html">
                ...
                <div class="col-xs-4">
                    <a href="http://www.twothink.cc/home/retive/index.html">
