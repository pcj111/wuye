<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"F:\twothink\TwoThink\public/../application/admin/view/default/property\index.html";i:1521878894;s:78:"F:\twothink\TwoThink\public/../application/admin/view/default/public\base.html";i:1521712368;s:82:"F:\twothink\TwoThink\public/../application/admin/view/default/public\sidemenu.html";i:1521712368;s:81:"F:\twothink\TwoThink\public/../application/admin/view/default/public\sidebar.html";i:1521712368;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="table-responsive margin-top-5">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    <td><?=$row['name']?></td>
                    <td><?=$row['tel']?></td>
                    <td><?=$row['status']?'处理':未处理?></td>
                    <td><?=date('Y-m-d H:i:s',$row['time']-0)?></td>
                    <td><?=$row['intro']?></td>
                    <td><?=$row['sn']?></td>
                    <td>
                        <a href="<?php echo url('admin/property/edit',['id'=>$row[id]]); ?>
"><i class="btn btn-primary">修改</i></a>
                            <a href="<?php echo url('admin/property/out',['id'=>$row[id]]); ?>
"><i class="btn btn-danger">删除</i></a>
                        <a href="<?php echo url('admin/property/change',['id'=>$row[id]]); ?>
"><i class="btn btn-success">修改状态</i></a>
                    </td>
                </tr>
                <?php endforeach;?>
                </tbody>
