<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"F:\twothink\TwoThink\public/../application/admin/view/default/retive\index.html";i:1522045293;s:78:"F:\twothink\TwoThink\public/../application/admin/view/default/public\base.html";i:1521712368;s:82:"F:\twothink\TwoThink\public/../application/admin/view/default/public\sidemenu.html";i:1521712368;s:81:"F:\twothink\TwoThink\public/../application/admin/view/default/public\sidebar.html";i:1521712368;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div>
<a href="<?php echo url('admin/retive/add'); ?>
    "><i class="btn btn-primary">添加</i></a>
</div>
<div class="row">
    <div class="col-xs-12">
        <!-- 数据列表 -->
        <div class="table-responsive margin-top-5">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td><?=$row['status']?'活动进行中':'活动已结束'?></td>
                    <td><?=$row['sale']?'发布':'未发布'?></td>
                    <td>
                        <a href="<?php echo url('admin/retive/edit',['id'=>$row[id]]); ?>
"><i class="btn btn-primary">修改</i></a>
                            <a href="<?php echo url('admin/retive/out',['id'=>$row[id]]); ?>
"><i class="btn btn-danger">删除</i></a>
                        <a href="<?php echo url('admin/retive/look',['id'=>$row[id]]); ?>
"><i class="btn btn-success">查看详情</i></a>
                        <a href="<?php echo url('admin/retive/sale',['id'=>$row[id]]); ?>
"><i class="btn btn-primary"><?=$row['sale']==0?'发布':'撤回'?></i></a>
                    </td>
                </tr>
                <?php endforeach;?>
                </tbody>
