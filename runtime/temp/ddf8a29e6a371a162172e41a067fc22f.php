<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\twothink\TwoThink\public/../application/admin/view/default/notice\edit.html";i:1521861737;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form method="post" enctype="multipart/form-data">
            ...
            <div>
                <label>通知内容(必填):</label>
            <textarea type="text" class="form-control" name="detail" ><?=$row->detail?></textarea>
            </div>
            <div class="form-group">
