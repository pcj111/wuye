<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"F:\twothink\TwoThink\public/../application/admin/view/default/base\list.html";i:1521712368;s:78:"F:\twothink\TwoThink\public/../application/admin/view/default/public\base.html";i:1521712368;s:82:"F:\twothink\TwoThink\public/../application/admin/view/default/public\sidemenu.html";i:1521712368;s:81:"F:\twothink\TwoThink\public/../application/admin/view/default/public\sidebar.html";i:1521712368;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="btn-group seach-main col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="layui-input-inline value-html">
                        ...
                        <select name="seach_all[value][]" lay-filter="<?php echo $name; ?>_name">
                            <?php $_5ab608b6ceaf5=parse_field_attr($vo['extra']); if(is_array($_5ab608b6ceaf5) || $_5ab608b6ceaf5 instanceof \think\Collection || $_5ab608b6ceaf5 instanceof \think\Paginator): if( count($_5ab608b6ceaf5)==0 ) : echo "" ;else: foreach($_5ab608b6ceaf5 as $k=>$vos): ?>
...
<div class="extra_list" style="display: none;">
    ...
    <div class="<?php echo $vo['name']; ?>_extra_html">
        <?php switch($vo['type']): case "select": ?>
        <select name="seach_all[value][]" lay-filter="<?php echo $name; ?>_name">
            <?php $_5ab608b6cea7e=parse_field_attr($vo['extra']); if(is_array($_5ab608b6cea7e) || $_5ab608b6cea7e instanceof \think\Collection || $_5ab608b6cea7e instanceof \think\Paginator): if( count($_5ab608b6cea7e)==0 ) : echo "" ;else: foreach($_5ab608b6cea7e as $k=>$vos): ?>
            <option value="<?php echo $k; ?>" <?php if($k == $vo['value']): ?> selected="selected" <?php endif; ?>><?php echo $vos; ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php break; case "date": ?>date<?php break; case "datetime": ?>date<?php break; default: ?><input name="seach_all[value][]" class="layui-input" type="text" value="<?php echo $vo['value']; ?>">
