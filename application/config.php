...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'u>)BHM<_/WDs{![ylFJEp#PwO52I6?AQam-~vn0G', //默认数据加密KEY
	'data_cache_key'=> 'u>)BHM<_/WDs{![ylFJEp#PwO52I6?AQam-~vn0G',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'u>)BHM<_/WDs{![ylFJEp#PwO52I6?AQam-~vn0G', //加密KEY
